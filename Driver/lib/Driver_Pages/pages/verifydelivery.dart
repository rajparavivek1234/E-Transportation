// ignore_for_file: unused_local_variable, unused_import, import_of_legacy_library_into_null_safe, camel_case_types, use_key_in_widget_constructors, prefer_const_constructors_in_immutables, prefer_final_fields, unnecessary_string_interpolations, prefer_const_constructors, avoid_print, sized_box_for_whitespace, avoid_unnecessary_containers, annotate_overrides
...
class verifydelivery extends StatefulWidget {
  ...
  verifydelivery({required this.phone, required this.codeDigits});
  @override
                      ...
                      await FirebaseAuth.instance
                        ...
                        (value) async {
                          if (value.user != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text("Delivery Verified"),
                                backgroundColor: Colors.orangeAccent,
                              ),
                            );
