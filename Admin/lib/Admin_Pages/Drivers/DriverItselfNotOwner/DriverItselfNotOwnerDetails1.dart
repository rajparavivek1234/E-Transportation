...
class Driver_ItSelf_Not_Owner_Details_Page1 extends StatelessWidget {
  String id = "";
  String adharcard = "";
  String addressproof = "";
  String licence = "";
  Driver_ItSelf_Not_Owner_Details_Page1({required this.id});
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                Driver_ItSelf_Not_Owner_Details_Page2(id: id),
                          ),
                        );
                      },
