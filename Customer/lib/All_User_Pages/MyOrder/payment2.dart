...
class Payment2 extends StatefulWidget {
  String? rid;
  Payment2({Key? key, this.rid}) : super(key: key);
  @override
  State<Payment2> createState() => _PaymentState();
}
...
class _PaymentState extends State<Payment2> {
  ...
  void openCheckout() {
    var options = {
      ...
      "description": "Payment2 for your trip",
      "prefill": {
        "contact": "2323232323",
  ...
  void handlePaymentSuccess(PaymentSuccessResponse response) async {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("Payment2 Successful."),
